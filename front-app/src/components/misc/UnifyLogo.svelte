<script>
export let upColor="#45B877";
export let downColor="#FFFFFF"
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 600 600" style="enable-background:new 0 0 600 600; width:{width}" xml:space="preserve">
<g>
	<g>
    <path class="st0" style="fill:{downColor}"d="M459.3,235.9L325.9,466.6c-47.1,81.5-151.7,109.5-233.2,62.3c-39.4-22.8-67.6-59.6-79.4-103.7
...
<g>
	<g>
		<path class="st1" style="fill:{upColor}"d="M571.1,300.3L437.9,531c-11.3,19.6-36.5,26.4-56.2,15.1c-19.6-11.3-26.4-36.5-15.1-56.2l133.2-230.7
