...
<div class="u-view">
    ...
    <div class="u-container">
        ...
        <div  class="body">Unify is the #1 dedicated platform for Creators in Tunisia. Unify offerings span mobile application, Creator Sites, Merch, and offers services for the Creator to design and optimize their content creation. Unify is a service that allows viewers to send and receive money ("tips") through third-party payment processors. Our service also features a variety of widgets that can utilize various data from our services, and data from authorized third parties.</div>
     
     
        <div  class="head">USER TERMS</div>
        <div  class="body">
            The Unify Services are not available to persons under the age of 13. If you are between the ages of 13 and 18 (or between 13 and the age of legal majority in your jurisdiction of residence), you may only use the Unify Services under the supervision of a parent or legal guardian who agrees to be bound by these Terms of Service.
        ...
        <div  class="head">GENERAL CONDITIONS</div>
        <div  class="body">
        ...
        <div  class="head">RECEIVING TIPS</div>
        <div  class="body">
            We reserve the right to collect a fee for tips received. Fees are subject to change without prior notification, it is your responsibility as the user to stay updated on Fees and changes to the Fees.The recipient of tips are not required to acknowledge or accept them. You agree that you will not hold Unify liable for any unclaimed or unacknowledged tips.
